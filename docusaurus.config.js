...
const config = {
  title: 'CustUp',
  tagline: 'CustUp custom file uploader',
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/paulosabayomi/custup-doc/tree/main/',
        },
        blog: {
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} CustUp. Built with &#9829; by <a href="https://github.com/paulosabayomi">Paulos Ab</a>.`,
      },
      prism: {
